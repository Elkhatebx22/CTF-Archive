...
When the premise of a thing relies solely on the truth of its conclusion, it can only be described as a logical fallacy.
...
Check out his writeup [here](https://medium.com/@King_Night/l3akctf-2026-osint-write-up-d0803b3a4a18).
