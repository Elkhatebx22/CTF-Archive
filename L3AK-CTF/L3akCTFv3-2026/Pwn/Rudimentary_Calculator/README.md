...
- **Category:** Pwn
- **Solves:** 107
- **Connection:** `ncat --ssl rudimentary-calculator.instances.ctf.l3ak.team 1337`

## Description

People tell me I should implement the standard functionality first, before adding fancy features. But where's the fun in that?
