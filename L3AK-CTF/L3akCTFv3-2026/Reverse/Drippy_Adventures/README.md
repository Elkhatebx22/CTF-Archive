...
![Signs depicting the storyline and controls](assets/controls_story.png)

Taking a quick look around reveals the seemingly large flag in the distance. Now we have our target.

![Large flag in the distance](assets/flag1FromStart.png)
...
![dnSpy file explorer](assets/dnSpyfiles.png)
...
![flag3 jump before](assets/scriptJumpLogicBefore.png)

![flag3 jump after](assets/scriptJumpLogicAfter.png)
...
![Location Directly after teleporting](assets/teleportLocation.png)

![Flag Part 2](assets/flagPart2.png)

This gives us part of the flag, `{H4ck3r`.

![Sign 4](assets/sign4.png)
...
![Flag Part 3](assets/flagPart3.png)

This gives us another part of the flag, `_0f_G4M35`.

![Sign 5](assets/sign5.png)
...
![Signs at the given coordinates in level176](assets/ocean_story.png)
...
![Underwater Box](assets/underwaterBox.png)

With this method, I was able to get into the box and recover another part of the flag and 2 more signs.

![Part 4 of the Flag](assets/flagPart4.png)

![Underwater Box Signs](assets/underwaterBoxSigns.png)
...
![Part 5 of the Flag](assets/flagPart5.png)
