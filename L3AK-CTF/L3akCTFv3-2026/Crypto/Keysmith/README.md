...
- **Category:** Crypto
- **Solves:** 1
- **Connection:** `ncat --ssl keysmith.instances.ctf.l3ak.team 1337`

## Description

When a lock can be opened by multiple keys, is it a bad lock or is there just a good keysmith around?
