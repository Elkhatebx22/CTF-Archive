...
- **Category:** Crypto
- **Solves:** 7
- **Connection:** `ncat --ssl csc265.instances.ctf.l3ak.team 1337`

## Description

I learned about bloom filters last semester in my data structures course! Let's put a cryptographic spin on them.
