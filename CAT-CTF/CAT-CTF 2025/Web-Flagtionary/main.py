...
setup_queries = [
    "INSERT INTO dict(word, meaning) VALUES('flag', 'CATF{bl4ckl1st_b3l0ngs_1n_th3_tr4sh}')",
    ...
    "INSERT INTO dict(word, meaning) VALUES('FD', 'File Descriptor')",
]
...
def search():
    ...
    if "'" in word or len(word)!=2 :
        ...
        try:
            # it's prepared statement don't waste your time with SQLi
